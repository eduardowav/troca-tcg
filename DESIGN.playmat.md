# Design — Playmat (congelado em 2026-08-03)

> **Cópia de segurança do mundo visual original.** Este arquivo é uma fotografia
> do `DESIGN.md` como ele estava no commit `af682b9`, antes de qualquer decisão
> sobre a pele neobrutalista que está em avaliação nas rotas de troca
> (`web/src/estilos/brutal.css`).
>
> Ele não é lido por ferramenta nenhuma e não descreve o estado atual do app: é o
> registro do playmat para o caso de o brutalismo ser aprovado e o `DESIGN.md`
> ser reescrito, ou para voltar atrás sem ter de reconstruir a direção de
> memória. Se o playmat continuar sendo o mundo do projeto, esta cópia pode ser
> apagada — o `DESIGN.md` já diz tudo o que está aqui.
>
> A partir daqui, texto idêntico ao original.
